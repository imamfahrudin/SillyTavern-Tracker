...
async function onGenerateAfterCommands(type, options, dryRun) {
	...
	if (!enabled || chat.length == 0 || (selected_group && !is_group_generating) || (typeof type != "undefined" && !["continue", "swipe", "regenerate", "impersonate", "group_chat", "normal"].includes(type))) {
